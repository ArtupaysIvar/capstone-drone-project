...
#include "pixel_msgs/msg/detail/pixel_coordinates__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pixel_msgs::msg::PixelCoordinates;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pixel_msgs::msg::PixelCoordinates *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pixel_msgs::msg::PixelCoordinates *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_pixel_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<pixel_msgs::msg::PixelCoordinates>()
{
  return &pixel_msgs::msg::typesupport_fastrtps_cpp::_PixelCoordinates__handle;
}
